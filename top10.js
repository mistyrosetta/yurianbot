...
exports.run = async (client, message) => {
  ...
  if (client.guilds.size < 10) return message.reply("Botun en az `10` tane sunucuda bulunması gerekir!")
...
exports.help = {
name: "top10",
description: "Yurian botun bulunduğu en iyi 10 serveri gösterir.",
usage: "top10"
};